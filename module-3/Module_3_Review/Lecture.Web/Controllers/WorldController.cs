...
namespace Lecture.Web.Controllers
{
    public class WorldController : Controller
    {
        ...
        /* 1. Create the world controller index, 2. create the razor file 3. create the model
           4. create a dal method to get the countries 5. call it from teh controller
           6. pass the model into the view 7. bind the view to the model
           8. create cities by country 9. create teh cities model 10 call the dal
           11 pass the model to the view*/
