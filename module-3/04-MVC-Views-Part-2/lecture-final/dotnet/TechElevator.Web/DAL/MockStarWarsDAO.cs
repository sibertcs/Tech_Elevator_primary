...
namespace TechElevator.Web.DAL
{
    public class MockStarWarsDAO : IStarWarsDAO
    {
        ...
        private List<Film> films = new List<Film>()
        {
            ...
            new Film() { Id = "swix", Name = "Star Wars Episode IX", Length = null, YearReleased = 2019, ImageUrl = null }
        };
        ...
        public Film GetFilm(string id)
        {
            ...
            {
                if (film.Id.ToLower() == id.ToLower())
                    return film;
            }
            return films[0]; //return the first one
            */
