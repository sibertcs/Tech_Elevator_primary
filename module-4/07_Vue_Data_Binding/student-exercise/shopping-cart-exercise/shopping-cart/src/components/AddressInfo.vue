      ...
      <div class="col-8">
        <form>
          ...
          <div class="billing-add">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="billingSameCheckbox"/>
              <label class="form-check-label" for="billingSameCheckbox">Billing Same as Shipping</label> </div>
            <div class="form-group">
