<template>
    <div class="main">
        ...
        <div class="review" v-for="review in reviews" v-bind:key="review.id">
            ...
            <fieldset v-show="review.rating > 3">
                 <h1> WOW </h1> 
                 <p> I'm so glad that you like this book. Squirrels are great.</p>
            </fieldset>
            <h1 v-show="review.rating < 2 && name=='Cigar Parties for Dummies'"> Can you even read? </h1>
            <h3>{{ review.title }}</h3>
