    ...
    <div class="main">
        ...
        <div class="well-display">
            <div class="well" v-on:click="filter=0">
                <!--since the listener is on the well, the listener is on the 
                text as well-->
            ...
            <div class="well" >
                <!--only the number is clickable, not the text since the listener is
                on the span -->
...
export default {
    ...
    computed: {
        ...
        numberOfTwoStarReviews(x) { //don't really do this. just an example
            return x.numberOfReviews(x.reviews, 2);
        },
        numberOfThreeStarReviews(vm) { //kind of old but you might see it
