...
SELECT name, lifeexpectancy, region
FROM country
WHERE region LIKE '%europe' AND lifeexpectancy IS NOT NULL

-- The name, continent, GNP, and average life expectancy of all countries in Africa or Asia that have an average life expectancy of at least 70 years and a 
--GNP between $1 million and $100 million dollars

SELECT name, continent, gnp, lifeexpectancy FROM country WHERE continent IN ('Africa','Asia') AND lifeexpectancy >= 70 and gnp between 1000 AND 100000